...
namespace test_pareto_lfm_extmo_distribution {
...
using generic_parm_t = test_pareto_lfm_extmo_distribution::generic_param_type;

template <typename lfm_extmo_dist_t, typename generic_parm_t>
void tester_distribution<lfm_extmo_dist_t, generic_parm_t>::__param_test(
...
using dist_tester_t = tester_distribution<lfm_extmo_dist_t, generic_parm_t>;

context("pareto_lfm_extmo_distribution") {
  const std::vector<generic_parm_t> test_cases = {
      generic_parm_t{},
      generic_parm_t{std::size_t{2}, 0., 0., 1., jump_parm_t{.5, 0.005}}};
  auto dist_tester = dist_tester_t{"pareto_lfm_extmo_distribution", test_cases};
