...
NumericMatrix Rcpp__rmo_esm(
  ...
  ESMGenerator<MatrixRow<REALSXP>, RRNGPolicy> esm_generator(
    d, intensities);
...
NumericMatrix Rcpp__rmo_arnold(
    ...
    const NumericVector& intensities) {
  ArnoldGenerator<MatrixRow<REALSXP>, RRNGPolicy> arnold_generator(d, intensities);
...
NumericMatrix Rcpp__rmo_ex_arnold(
  ...
  ExArnoldGenerator<MatrixRow<REALSXP>, RRNGPolicy> ex_arnold_generator(d, ex_intensities);
...
NumericMatrix Rcpp__rmo_esm_cuadras_auge(
  ...
  CuadrasAugeGenerator<MatrixRow<REALSXP>, RRNGPolicy> cuadras_auge_generator(d, alpha, beta);
