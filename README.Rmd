...
more guidance, refer to our [integration
test](https://github.com/hsloot/rmo/blob/master/other/integration-test.Rmd) and
submit an [issue
...
Contribution to `rmo` are welcome! You contribution can be about improving the
