...
The following document is a compendium for the *Marshall--Olkin distribution*. For a detailed mathematical treatment of this class, we refer to the references at the end of this document.
...
- \(Y_1, Y_2, \ldots\) iid in \(\mathbb{P} (\{1, \ldots, d\}) \backslash \{ 0\}\) with \(\mathbb{P} (Y_1 = I) = p_I, \ \emptyset \neq I \subseteq \{ 1, \ldots , d\}\).
