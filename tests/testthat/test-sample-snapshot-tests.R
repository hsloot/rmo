...
test_that("Snapshot tests for `rpextmo`", {
  ...
  eta <- 0.5
  expect_snapshot(rpextmo(10, 3, a = a, b = b, gamma = gamma, eta = eta, family = "Exponential"))
  expect_snapshot(
    rpextmo(10, 3, a = a, b = b, gamma = gamma, eta = eta, family = "Exponential", method = "MDCM"))
  expect_snapshot(
    rpextmo(10, 3, a = a, b = b, gamma = gamma, eta = eta, family = "Exponential", method = "LFM"))
  expect_snapshot(
    rpextmo(10, 3, a = a, b = b, gamma = gamma, eta = eta, family = "Exponential", method = "AM"))
  expect_snapshot(
    rpextmo(10, 3, a = a, b = b, gamma = gamma, eta = eta, family = "Exponential", method = "ESM"))

  eta <- 0.5
  expect_snapshot(rpextmo(10, 3, a = a, b = b, gamma = gamma, eta = eta, family = "AlphaStable"))
  expect_snapshot(
    rpextmo(10, 3, a = a, b = b, gamma = gamma, eta = eta, family = "AlphaStable", method = "MDCM"))
  expect_snapshot(
    rpextmo(10, 3, a = a, b = b, gamma = gamma, eta = eta, family = "AlphaStable", method = "AM"))
  expect_snapshot(
    rpextmo(10, 3, a = a, b = b, gamma = gamma, eta = eta, family = "AlphaStable", method = "ESM"))
  ...
  expect_snapshot(
    rpextmo(
      10, 3, a = a, b = b, gamma = gamma, eta = eta, family = "InverseGaussian", method = "MDCM"))
  expect_snapshot(
    rpextmo(
      10, 3, a = a, b = b, gamma = gamma, eta = eta, family = "InverseGaussian", method = "AM"))
  expect_snapshot(
    rpextmo(
      10, 3, a = a, b = b, gamma = gamma, eta = eta, family = "InverseGaussian", method = "ESM"))
