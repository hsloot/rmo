...
class CountNoReplaceWalker : public UnivariateWalker<std::size_t, RNGPolicy> {
 public:
  ...
  explicit CountNoReplaceWalker(const Vector& probabilities);
...
template <typename RNGPolicy>
class UnifCountNoReplaceWalker
    : public UnivariateWalker<std::size_t, RNGPolicy> {
 public:
  ...
  explicit UnifCountNoReplaceWalker(const std::size_t n);

  virtual ~UnifCountNoReplaceWalker() = default;

  UnifCountNoReplaceWalker& operator=(const UnifCountNoReplaceWalker& other) =
      default;
  UnifCountNoReplaceWalker& operator=(UnifCountNoReplaceWalker&& other) =
      default;
