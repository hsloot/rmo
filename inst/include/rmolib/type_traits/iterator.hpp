...
// output iterator
template <typename _Iterator>
struct is_output_iterator : public iterator_internal::has_iterator_category<
                                _Iterator, std::output_iterator_tag> {};
...
// forward iterator
template <typename _Iterator>
struct is_forward_iterator : public iterator_internal::has_iterator_category<
                                 _Iterator, std::forward_iterator_tag> {};
...
struct is_bidirectional_iterator
    : public iterator_internal::has_iterator_category<
          _Iterator, std::bidirectional_iterator_tag> {};
...
struct is_random_access_iterator
    : public iterator_internal::has_iterator_category<
          _Iterator, std::random_access_iterator_tag> {};
